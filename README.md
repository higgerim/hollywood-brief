...
나 (5분)           ─ newsletter.md를 복사해 메일리에 붙여넣고 발행
```
...
| 뉴스레터 | Merge 후 `drafts/날짜/newsletter.md`에서 본문을 복사해 메일리 에디터에 붙여넣고 발행해요 |
...
- 연예인 사진이나 AI로 만든 인물 이미지는 쓰지 않아요. 저작권과 초상권 문제 때문이고, 카드는 텍스트로만 구성해요.
